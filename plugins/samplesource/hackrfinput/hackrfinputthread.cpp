...
hackrf_error HackRFInputThread::startHackRF() {
    return (hackrf_error) hackrf_start_rx(m_dev, rx_callback, this);
}

bool HackRFInputThread::hackRFIsStreaming() {
    return hackrf_is_streaming(m_dev) == HACKRF_TRUE;
}
